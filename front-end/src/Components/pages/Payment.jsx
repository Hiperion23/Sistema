          ...
          <div className="p-8 modal-content">
            ...
            <form id="createPaymentForm" className="flex flex-col">
              <div className="flex mb-6">
                ...
                <input type="text" className="flex-1 border border-pink-600 rounded form-control" id="idPurchase" name="idPurchase" onChange={handleInputChange} required />
              </div>
              <div className="flex mb-6">
                <label htmlFor="paymentAmount" className="mb-0 mr-2 form-label">Payment Amount</label>
                <input type="number" className="flex-1 border border-pink-600 rounded form-control" id="paymentAmount" name="paymentAmount" onChange={handleInputChange} required />
              </div>
              <div className="flex mb-6">
                <label htmlFor="paymentDate" className="mb-0 mr-2 form-label">Payment Date</label>
                <input type="datetime-local" className="flex-1 border border-pink-600 rounded form-control" id="paymentDate" name="paymentDate" onChange={handleInputChange} required />
              </div>
              <div className="flex mb-6">
                <label htmlFor="status" className="mr-2 form-label">Status</label>
                <input type="text" className="flex-1 border border-pink-600 rounded form-control" id="status" name="status" onChange={handleInputChange} required />
              </div>
            </form>
            <div className="flex justify-end mt-6">
              ...
              <button
                type="button"
                className="w-20 bg-purple-900 rounded btn btn-danger text-white"
